...
RUN apt-get update && apt-get install -y vim && rm -rf /var/lib/apt/lists/* && \
    curl -SL http://sourceforge.net/projects/jasperserver/files/JasperServer/JasperReports%20Server%20Community%20Edition%206.0.1/jasperreports-server-cp-6.0.1-bin.zip -o /tmp/jasperserver.zip && \
